...
// 函数
// 切换popupName的值
const changePopupName = (name: typeof popupName.value) => {
...
const onChnage: UniHelper.SwiperOnChange = (e) => {
  curIndex.value = e.detail.current
}
const onPreviewImage = (curUrl: string) => {
  uni.previewImage({
    current: curUrl,
...
const skuPopup = (curMode: skuMode) => {
...
<template>
  ...
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview">
        <swiper circular @change="onChnage">
          <swiper-item v-for="item in goodsList?.mainPictures" :key="item">
            <image mode="aspectFill" :src="item" @tap="onPreviewImage(item)" />
          </swiper-item>
        </swiper>
      ...
      <!-- 操作面板 -->
      <view class="action">
        <view class="item arrow" @tap="skuPopup(skuMode.BOTH)">
          <text class="label">选择</text>
          <text class="text ellipsis"> {{ goodSkuVal }} </text>
        </view>
        <view class="item arrow" @tap="changePopupName('address')">
          <text class="label">送至</text>
          <text class="text ellipsis"> 请选择收获地址 </text>
        </view>
        <view class="item arrow" @tap="changePopupName('service')">
    ...
    <view class="detail panel">
      ...
      <view class="content">
        ...
        <!-- 图片详情 -->
        <image v-for="item in goodsList?.details.pictures" mode="widthFix" :src="item"></image>
      </view>
    </view>
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    ...
    <view class="buttons">
      <view class="addcart" @tap="skuPopup(skuMode.CART)"> 加入购物车 </view>
      <view class="buynow" @tap="skuPopup(skuMode.BUY)"> 立即购买 </view>
    </view>
  </view>
