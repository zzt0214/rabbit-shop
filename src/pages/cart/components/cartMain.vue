...
// 修改商品状态
const onChangeStatus = (item: CartItem) => {
...
const goPayment = () => {
  ...
  // 跳转到支付页面
  uni.showToast({ icon: 'success', title: '跳转支付' })
}
</script>
...
<template>
  <scroll-view scroll-y class="scroll-view">
    <!-- 已登录: 显示购物车 -->
    <template v-if="memberInfo.profile">
      <!-- 购物车列表 -->
      ...
      <!-- 吸底工具栏 -->
      <view class="toolbar">
        <text @tap="onSelectAll" class="all" :class="{ checked: isSelectedAll }">全选</text>
        <text class="text">合计:</text>
        <text class="amount">{{ selectedMoney }}</text>
